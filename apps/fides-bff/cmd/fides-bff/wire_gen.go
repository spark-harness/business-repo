...
// DI frameworks.
func wireApp(confServer *conf.Server, applicant *conf.Applicant, authConf *conf.Auth, registry *conf.Registry, version biz.Version, logger log.Logger) (*kratos.App, func(), error) {
	...
	httpServer := server.NewHTTPServer(confServer, healthService, authService, sessionTokenValidator, idempotencyStore, logger)
